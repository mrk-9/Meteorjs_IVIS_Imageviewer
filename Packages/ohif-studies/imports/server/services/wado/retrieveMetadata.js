...
function resultDataToStudyMetadata(server, studyInstanceUid, resultData) {
    ...
    var studyData = {
        ...
        referringPhysicianName: anInstance['00080090'],
        referringPhysicianAddress: anInstance['00080092'],
        referringPhysicianTelephoneNumber: anInstance['00080094'],
        referringPhysicianIDSequence: anInstance['00080096'],
        codeValue: anInstance['00080100'],
        studyID: anInstance['00200010'],
        patientBirthDate: anInstance['00100030'],
        patientSex: anInstance['00100040'],
        patientOrientation: anInstance['00200020']
    };
