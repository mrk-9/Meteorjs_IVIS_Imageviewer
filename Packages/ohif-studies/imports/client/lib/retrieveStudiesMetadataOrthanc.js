 ...
 * @return Promise
 */
OHIF.studies.retrieveStudiesMetadataOrthanc = (studyInstanceUids, seriesInstanceUids) => {
    ...
    studyInstanceUids.forEach(function(studyInstanceUid) {
        ...
        const promise = OHIF.studies.retrieveStudyMetadataOrthanc(studyInstanceUid, seriesInstanceUids);
