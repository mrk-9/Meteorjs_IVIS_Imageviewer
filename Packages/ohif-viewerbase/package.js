...
Package.onUse(function(api) {
	...
	api.addFiles('client/components/viewer/metadataDialog/metadataDialog.html', 'client');
    api.addFiles('client/components/viewer/metadataDialog/metadataDialog.js', 'client');
    api.addFiles('client/components/viewer/metadataDialog/metadataDialog.styl', 'client');
