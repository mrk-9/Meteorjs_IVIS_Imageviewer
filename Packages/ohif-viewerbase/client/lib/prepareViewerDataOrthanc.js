 ...
 */
export const prepareViewerDataOrthanc = ({ studyInstanceUids, seriesInstanceUids, timepointId, timepointsFilter={} }) => {
    ...
    const promise = new Promise((resolve, reject) => {
        const processData = viewerData => {
            OHIF.studies.retrieveStudiesMetadataOrthanc(viewerData.studyInstanceUids, viewerData.seriesInstanceUids).then(studies => {
