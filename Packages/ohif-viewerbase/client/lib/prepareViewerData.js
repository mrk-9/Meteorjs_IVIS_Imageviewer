 ...
 */
export const prepareViewerData = ({ studiesData }) => {
    ...
    const promise = new Promise((resolve, reject) => {
        const processData = (studiesData, viewerData) => {
            OHIF.studies.retrieveStudiesMetadata( studiesData ,viewerData).then(studies => {
        ...
        studyInstanceUids = [studiesData['studies'][0].studyInstanceUid];
            //studyInstanceUids = ["1.2.392.200036.9116.2.6.1.48.1214835307.1377566709.779731"];
        ...
        if (studyInstanceUids && studyInstanceUids.length) {
            ...
            processData(studiesData, viewerData);
        } else {
