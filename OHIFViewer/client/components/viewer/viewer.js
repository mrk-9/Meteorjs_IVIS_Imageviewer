...
Meteor.startup(() => {
    ...
    OHIF.viewer.functionList = {
		...
		toggleMetadataDialog: viewportUtils.toggleMetadataDialog,
...
Template.viewer.events({
    ...
    'click #viewer *'(event) {
        ...
        // const checkReportVisible = $('#view-reportDialog-pdf').is(':visible');
        // if(checkReportVisible == true) {
        //     $('#view-reportDialog-pdf').css('display', 'none');
        // }        
    },
    'click .modal' (event) {
        let dialog = $(event.target).parent('dialog').removeAttr('open');
