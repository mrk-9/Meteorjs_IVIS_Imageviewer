...
https://atmospherejs.com/rkhaslarov/simple-pagination     :        meteor add rkhaslarov:simple-pagination
https://github.com/aslagle/reactive-table				  :		   meteor add aslagle:reactive-table
